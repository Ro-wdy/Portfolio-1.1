...
document.addEventListener("DOMContentLoaded", function () {
  ...
  contactForm.addEventListener("submit", function (e) {
    ...
    emailjs
      .send("service_3wb0jbj", "template_majr3oi", templateParams)
      ...
      .catch(function (error) {
        ...
        showMessage(
          "There was an issue sending your message directly. Please try again or " +
            '<a href="' +
            mailtoLink +
            '" style="color: #3b82f6; text-decoration: underline;">click here to send via your email client</a>.',
          "error"
        );
      })
      .finally(function () {
  ...
  function initAlternativeContact() {
    ...
    const emailElements = document.querySelectorAll(
      '[href*="mailto"], .contact-info p:first-child'
    );
